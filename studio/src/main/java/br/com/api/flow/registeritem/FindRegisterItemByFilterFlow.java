...
import br.com.api.flow.registeritem.item.FindRegisterItemByFilterFlowItem;
import br.com.api.utils.ReportTech;
import br.com.api.utils.ResponseAPI;
import br.com.api.utils.Utils;

@Service
public class FindRegisterItemByFilterFlow {
	...
	public ResponseAPI execute(RegisterItemFilter filter, HttpHeaders headers) {

		ResponseAPI response = ResponseAPI.builder().friendlyMessagesList(new ArrayList<>()).build();

		try {
			response.setData(findRegisterItemByFilterFlowItem.findByFilter(filter));
