...
import br.com.api.flow.matriculationitem.item.FindMatriculationItemByFilterFlowItem;
import br.com.api.utils.ReportTech;
import br.com.api.utils.ResponseAPI;
import br.com.api.utils.Utils;

@Service
public class FindMatriculationItemByFilterFlow {
	...
	public ResponseAPI execute(MatriculationItemFilter filter, HttpHeaders headers) {

		ResponseAPI response = ResponseAPI.builder().friendlyMessagesList(new ArrayList<>()).build();

		try {
			response.setData(findMatriculationItemByFilterFlowItem.findByFilter(filter));
