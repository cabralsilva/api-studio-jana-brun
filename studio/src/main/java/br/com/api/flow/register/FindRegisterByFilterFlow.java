...
import br.com.api.flow.register.item.FindRegisterByFilterFlowItem;
import br.com.api.utils.ReportTech;
import br.com.api.utils.ResponseAPI;
import br.com.api.utils.Utils;

@Service
public class FindRegisterByFilterFlow {
	...
	public ResponseAPI execute(RegisterFilter filter, HttpHeaders headers) {

		ResponseAPI response = ResponseAPI.builder().friendlyMessagesList(new ArrayList<>()).build();

		try {
			response.setData(findRegisterByFilterFlowItem.findByFilter(filter));
