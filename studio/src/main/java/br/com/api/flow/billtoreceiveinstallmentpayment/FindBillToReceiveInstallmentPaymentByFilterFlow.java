...
import br.com.api.flow.billtoreceiveinstallmentpayment.item.FindBillToReceiveInstallmentPaymentByFilterFlowItem;
import br.com.api.utils.ReportTech;
import br.com.api.utils.ResponseAPI;
import br.com.api.utils.Utils;

@Service
public class FindBillToReceiveInstallmentPaymentByFilterFlow {
	...
	public ResponseAPI execute(BillToReceiveInstallmentPaymentFilter filter, HttpHeaders headers) {

		ResponseAPI response = ResponseAPI.builder().friendlyMessagesList(new ArrayList<>()).build();

		try {
			response.setData(findBillToReceiveInstallmentPaymentByFilterFlowItem.findByFilter(filter));
