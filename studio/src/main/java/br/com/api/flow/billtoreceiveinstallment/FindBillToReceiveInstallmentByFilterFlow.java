...
import br.com.api.flow.billtoreceiveinstallment.item.FindBillToReceiveInstallmentByFilterFlowItem;
...
public class FindBillToReceiveInstallmentByFilterFlow {
	...
	public ResponseAPI execute(BillToReceiveInstallmentFilter filter, HttpHeaders headers) {

		ResponseAPI response = ResponseAPI.builder().friendlyMessagesList(new ArrayList<>()).build();

		try {
			response.setData(findBillToReceiveInstallmentByFilterFlowItem.findByFilter(filter));
