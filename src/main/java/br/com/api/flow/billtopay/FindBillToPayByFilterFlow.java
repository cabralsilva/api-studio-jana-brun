...
public class FindBillToPayByFilterFlow {
	...
	public ResponseEntity<ResponseAPI<BillToPayFilter>> execute(BillToPayFilter filter, HttpHeaders headers) {

		ResponseAPI<BillToPayFilter> response = ResponseAPI.<BillToPayFilter>builder()
