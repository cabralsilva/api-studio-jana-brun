...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<ResponseAPI<ProductDTO>> insert(@RequestBody ProductDTO productDTO, @RequestHeader HttpHeaders headers) {

		return ResponseEntity.ok(insertProductFlow.execute(productDTO, headers));
	}

	@PutMapping
	public ResponseEntity<ResponseAPI<ProductDTO>> update(@RequestBody ProductDTO productDTO, @RequestHeader HttpHeaders headers) {

		return ResponseEntity.ok(updateProductFlow.execute(productDTO, headers));
	}

	@PostMapping("/search")
	public ResponseEntity<ResponseAPI<ProductFilter>> find(@RequestBody ProductFilter filter, @RequestHeader HttpHeaders headers) {
